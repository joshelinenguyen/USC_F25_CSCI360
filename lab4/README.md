# Lab 4 (CSCI 360 - Introduction to Artificial Intelligence)

Lab instruction: [`lab 4.pdf`](lab 4.pdf). Due on Nov 15th, 2025, EOD PT.
...
Extra credit instruction: Include your extra credit work in the same Jupyter Notebook file. Note that extra credits **do not** overflow, meaning a final score >100pts will be treated as 100pts. Check [`lab 4.pdf`](lab 4.pdf) for details on extra credits grading.
...
- reported values (40 pts): Your program should output correct numerical results.

### Extra credit (max 20 pts; problem 2)

Check [`lab 4.pdf`](lab 4.pdf) for details on extra credits grading.
